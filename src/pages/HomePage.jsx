...
export default function HomePage() {
  return (
    <div className="flex min-h-dvh w-full max-w-full flex-col overflow-x-hidden lg:h-dvh lg:overflow-hidden">
      <HomeHeader />
      <main className="mx-auto flex w-full min-w-0 max-w-7xl flex-1 flex-col justify-start overflow-y-auto px-4 py-8 pb-10 md:px-12 lg:justify-center lg:overflow-hidden lg:py-6 lg:pb-6">
        <section className="mb-8 shrink-0 space-y-3 md:mb-10">
          <h1 className="text-[2rem] font-semibold tracking-tight text-on-surface sm:text-[2.25rem] lg:text-[2.75rem] lg:leading-[1.1]">
            Explore Products
          </h1>
        ...
        <section className="grid w-full min-w-0 shrink-0 gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:gap-5">
