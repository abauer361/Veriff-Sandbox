...
export default function ProofOfAddress() {
  ...
  return (
    ...
    >
      <div className="flex w-full min-w-0 flex-col gap-3 lg:min-h-0 lg:flex-1 lg:overflow-hidden">
        <div className="grid w-full min-w-0 gap-4 lg:min-h-0 lg:flex-1 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1fr)_minmax(0,1.1fr)] lg:items-stretch">
        ...
        <section className="grid w-full min-w-0 shrink-0 gap-4 rounded-xl bg-surface px-4 py-3 shadow-sm ring-1 ring-outline-variant/60 md:grid-cols-[0.9fr_2.1fr] md:px-5">
